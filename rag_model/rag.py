from . import keys
from . import utils
from . import parse_n_chunk
from . import embed
from . import search_n_retrieve
import bs4
...
def index_and_embed_cur_docs(input_folder=None, parsed_folder=None, parser_choice="Marker"):

    # Base directory of this file
    base_dir = keys.os.path.dirname(keys.os.path.abspath(__file__))

    # Resolve relative paths
    input_folder = input_folder or keys.os.path.join(base_dir, "../data")
    parsed_folder = parsed_folder or keys.os.path.join(base_dir, "../parsed_data")
